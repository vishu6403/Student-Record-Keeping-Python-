...
#TITLE AND LOGO CHITKARA
win.title('Database')
win.iconbitmap('main_window_icon\\data.ico')
#BG COLOR    <widget>.configure(background='black')
...
#------------------------------- FIRST WINDOW (NEW STUDENT)  ----------------------------

for i in range(6):
    t1.columnconfigure(i,weight=1)#FOR MAKING LOOPS
...
#------------------------------THIRD WINDOW (COUSRE CREATION) -------------------------------------

for i in range(6):
    t3.columnconfigure(i,weight=1)#COLUMNS
#------------------------
...
#------------------------------FIFTH WINDOW (COURSE ALLOCATION) --------------------------

for i in range(6):
    t5.columnconfigure(i,weight=1)#COLUMNS
#--------------------
